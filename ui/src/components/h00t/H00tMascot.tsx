...
import { useHootFloat } from "./h00t-float";
        ...
        >
          {poppedOut && (
            <div
              ...
              title="Reposition the floating coach avatar ΓÇö drag handle for the popped-out panel"
            >
        ...
        <div style={{
          ...
          >
            ...
            <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
              ...
              <button type="button" title={hootPinned ? "Unpin ΓÇö coach panel follows normal window stacking" : "Pin on top ΓÇö keep coach above IDE and browser windows"} onClick={() => setHootPinned(!hootPinned)}
          ...
          <Suspense fallback={<div style={{ flex: 1, display: "grid", placeItems: "center", color: "#8f8f8f", fontSize: 12 }}>Loading coachΓÇª</div>}>
