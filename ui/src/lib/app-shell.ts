...
/** Season B hubs — Advanced nav is curated, not a flat encyclopedia. */
export type NavHub = "Operate" | "Machine" | "Trust" | "Fleet" | "Configure";
...
/**
 * Routes grouped into five hubs (Season B1):
 * Operate · Machine · Trust · Fleet · Configure
 */
export const APP_ROUTES: AppRouteDef[] = [
  // Operate — daily spine (Basic mode)
  ...
  // Machine — local inference & environment
  { label: "Vitals", path: "/vitals", icon: Cpu, group: "Machine", tipId: "nav.bench", visibility: "advanced", loader: () => import("@/pages/BenchPage"), aliases: ["/bench"] },

  // Trust — HITL, spend, activity
  { label: "Approvals", path: "/approvals", icon: ShieldCheck, group: "Trust", tipId: "nav.approvals", visibility: "advanced", loader: () => import("@/pages/ApprovalsPage") },
  { label: "Token Ledger", path: "/burn", icon: Flame, group: "Trust", tipId: "nav.burn", visibility: "advanced", loader: () => import("@/pages/TokenLedgerPage") },
  { label: "Activity", path: "/activity", icon: CalendarDays, group: "Trust", tipId: "nav.activity", visibility: "advanced", loader: () => import("@/pages/ActivityPage") },

  // Fleet — portfolio narrative
  { label: "Portfolio", path: "/portfolio", icon: Compass, group: "Fleet", tipId: "nav.portfolio", visibility: "advanced", loader: () => import("@/pages/PortfolioPage") },
  { label: "Pipeline", path: "/pipeline", icon: Workflow, group: "Fleet", tipId: "nav.pipeline", visibility: "advanced", loader: () => import("@/pages/PipelinePage") },
  { label: "Memory", path: "/memory", icon: BookOpen, group: "Fleet", tipId: "nav.memory", visibility: "advanced", loader: () => import("@/pages/MemoryPage") },
...
/** Season B hub order for Advanced mode sidebar. */
export const NAV_GROUP_ORDER: NavHub[] = ["Operate", "Machine", "Trust", "Fleet", "Configure"];

export const HUB_BLURBS: Record<NavHub, string> = {
  Operate: "Daily spine — scan, build, launch, watch",
  Machine: "Local models, RTK, agents & inference health",
  Trust: "Approvals, spend, and activity truth",
  Fleet: "Portfolio, pipeline, and durable memory",
